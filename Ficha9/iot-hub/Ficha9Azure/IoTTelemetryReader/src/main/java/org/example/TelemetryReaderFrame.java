...
public class TelemetryReaderFrame extends JFrame{
    ...
    private static final String EVENT_HUBS_COMPATIBLE_ENDPOINT = "sb://ihsuprodamres096dednamespace.servicebus.windows.net/";

    // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
    private static final String EVENT_HUBS_COMPATIBLE_PATH = "iothub-ehub-diogo-ctes-6674565-f011064c01";

    // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
    private static final String IOT_HUB_SAS_KEY = "bP8FvuMyS4JbiXHPkb8wyc0G6KiHrHTIsI5OIEHXVHs=";
    ...
    public static void main(String[] args) {
        TelemetryReaderFrame frame = new TelemetryReaderFrame("Telemetry");
